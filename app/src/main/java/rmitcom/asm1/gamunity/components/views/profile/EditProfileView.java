...
public class EditProfileView extends AppCompatActivity implements ForumTagListAdapter.ItemLongClickListener{
    ...
    private void updatePost() {
        confirmEditButton.setOnClickListener(v -> {
            ...
            if (forumBackgroundUri.isEmpty()) {
                isValid = false;
                Toast.makeText(EditProfileView.this, "Background image cannot be empty", Toast.LENGTH_SHORT).show();
            }

            if (forumIconUri.isEmpty()) {
                isValid = false;
                Toast.makeText(EditProfileView.this, "Icon image cannot be empty", Toast.LENGTH_SHORT).show();
            }
                        ...
                        .addOnCompleteListener(checkingUser -> {
                            if(checkingUser.isSuccessful()){
                                for (QueryDocumentSnapshot document: checkingUser.getResult()){
                                    ...
                                    Toast.makeText(EditProfileView.this, "Sent notification to members",Toast.LENGTH_SHORT).show();
                                    Intent returnIntent = new Intent(EditProfileView.this, ForumView.class);
